...
class ErrorActivity : XhuBaseActivity() {
	private lateinit var error: XhuScheduleError
	...
	override fun initData() {
		...
		if (intent.getBundleExtra(Constants.INTENT_TAG_NAME_ERROR) == null)
			finish()
		error = intent.getBundleExtra(Constants.INTENT_TAG_NAME_ERROR).getSerializable(Constants.INTENT_TAG_NAME_ERROR) as XhuScheduleError
