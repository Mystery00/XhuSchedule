...
import com.weilylab.xhuschedule.newPackage.model.*
import com.weilylab.xhuschedule.newPackage.repository.local.dao.CourseDao
import com.weilylab.xhuschedule.newPackage.repository.local.dao.NoticeDao
...
@Database(entities = [Student::class, StudentInfo::class, Course::class, Test::class, Notice::class], version = 1)
